...
/*
   ...
   Do NOT use Leaflet's map "mousemove" event here.

   The mobile solution above deliberately uses non-interactive
   markers. On desktop, handling the native mouse movement
   directly on the map container is more reliable.

   This affects mouse hover only.

   Touch behaviour remains completely separate.
*/
...
function handleDesktopMouseMove(event) {
    ...
    /*
       A native mousemove is only generated by an actual mouse
       pointer, so this does not interfere with the touch system.
    */
    ...
    /*
       Convert the browser mouse position into Leaflet LatLng.
    */
    ...
    */
    ...
    /*
       Close the previous hover tooltip.
    */
...
/*
   Use native browser mouse events.

   This is the ONLY changed behaviour compared with your
   previous script.
*/
